...
class Settings:
    ...
    # AvatarTalk
    avatartalk_api_key: str | None = os.getenv("AVATARTALK_API_KEY") or os.getenv(
        "AT_API_KEY"
    )
    avatartalk_base_url: str = os.getenv(
        "AVATARTALK_API_BASE", "wss://api.avatartalk.ai"
    )
    ...
    livekit_token_ttl_seconds: int = int(os.getenv("LIVEKIT_TOKEN_TTL", "3600"))
