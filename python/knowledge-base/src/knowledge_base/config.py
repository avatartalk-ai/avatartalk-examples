...
class Settings:
    ...
    knowledge_base_directory_path: str = os.getenv("KNOWLEDGE_BASE_DIRECTORY_PATH", "./data")
    vector_store_name: str = os.getenv("VECTOR_STORE_NAME", "avatartalk_knowledge_base")
