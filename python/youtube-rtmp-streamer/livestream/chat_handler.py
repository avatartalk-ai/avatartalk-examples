...
class ChatHandler:
    ...
    def _default_system_prompt(self) -> str:
        ...
        return (
            ...
            "You're aware that your responses will be posted in the live chat and that "
            "an avatar narrator is also discussing topics on the stream - you work together but separately."
        )
